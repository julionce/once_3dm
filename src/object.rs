...
const POINT_CLOUD_ID: Uuid = Uuid {
    data1: 0x2488F347,
    data2: 0xF8FA,
    data3: 0x11d3,
...
const POLY_LINE_CURVE_ID: Uuid = Uuid {
    data1: 0x4ED7D4E6,
    data2: 0xE947,
    data3: 0x11d3,
    data4: [0xBF, 0xE5, 0x00, 0x10, 0x83, 0x01, 0x22, 0xF0],
...
impl TryInto<Kind> for Uuid {
    ...
    fn try_into(self) -> Result<Kind, Self::Error> {
        match self {
            ...
            POLY_LINE_CURVE_ID => Ok(Kind::PolyLineCurve),
